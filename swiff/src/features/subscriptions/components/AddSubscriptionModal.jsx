...
const AddSubscriptionModal = ({ isOpen, onClose, userId }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Add Subscription" size="large">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-blue-700 mt-1">
                Swiff will help you track renewal dates, calculate yearly costs, and remind you before renewals.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end space-x-3 pt-4">
          ...
          <Button
            type="submit"
            variant="primary"
            disabled={isSubmitting || createSubscriptionMutation.isPending}
          >
            {isSubmitting || createSubscriptionMutation.isPending ? 'Adding...' : 'Add Subscription'}
          </Button>
        </div>
      </form>
    </Modal>
